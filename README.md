...
- **This software can damage your hardware.** It sends real commands to real battery hardware and makes automated charge/discharge/export decisions. Misconfiguration, bugs, or misunderstanding what an automation does could result in battery damage, accelerated wear, or other hardware harm.
- **Intended for users with relevant technical knowledge.** Using this assumes you understand Home Assistant YAML, automations, and templating well enough to read and verify what this code actually does before running it — and that you have enough understanding of your own battery hardware (safe operating limits, SOC floors, manufacturer guidance) to judge whether these automations are appropriate for your setup. If you don't have that background, either don't use this, or have someone who does review it with you first.
- **By using or copying this code, you accept full responsibility for the outcome on your own system.** This includes any hardware damage, financial loss, or other consequences. This is not shared or transferred to the author in any way.
